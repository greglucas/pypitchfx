...
# -*- coding: utf-8 -*-
#
# pypitchfx documentation build configuration file, created by
...
htmlhelp_basename = 'pypitchfxdoc'
...
latex_documents = [
  ('index', 'pypitchfx.tex', 'pypitchfx Documentation',
   'Ariel Rokem', 'manual'),
]
...
man_pages = [
    ('index', 'pypitchfx', 'pypitchfx Documentation',
     ['Greg Lucas'], 1)
]
...
texinfo_documents = [
  ('index', 'pypitchfx', 'pypitchfx Documentation',
   'Ariel Rokem', 'pypitchfx', 'One line description of project.',
   'Miscellaneous'),
]
